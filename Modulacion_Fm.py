...
plt.close (all)
Vm= float (input("ingrese amplitud modularidad:  "))
...
n_positivos=bessel[1:!1]; #componentes positivos de los componentes bessel
...
f_pnW.append(PndBm) #llenar el vector con el calculo anteirior
...
f_Pndm.append(PndBm) #llenar el vector con el calculo anterior
...
print ("Vfm(t)=",Vc, "cos[2",Fc,"t +",B, "sen(2",Fm,"t)]")
print()
